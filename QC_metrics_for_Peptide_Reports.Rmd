...
df_numberProjects2 <- data.frame(sequences=df_numberProjects$sequence,  numberProjects=df_numberProjects$numberProjects.2, peptideNumberSpectra=df_numberProjects$numberProjects.2)

df_numberProjects3 <- df_final[is.na(df_final$PEH.2),]
df_numberProjects4 <- data.frame(sequences=df_numberProjects$sequence, numberProjects=df_numberProjects$numberProjects.1, peptideNumberSpectra=df_numberProjects$numberProjects.1)
...
df_cluster2 <- data.frame(sequences=df_cluster$sequence, modifications=df_cluster$modifications, peptideNumberSpectra=df_cluster$peptideNumberSpectra.2)

df_cluster3 <- df_final[is.na(df_final$PEH.2),]
df_cluster4 <- data.frame(sequences=df_cluster$sequence, modifications=df_cluster$modifications, peptideNumberSpectra=df_cluster$peptideNumberSpectra.1)
